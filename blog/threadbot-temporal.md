...
<div class="blog-content-block">
    <img src="/img/blog/threadbot-mcp-screen-tool-discovery.png" />
    <span style="opacity:0.5;font-size:14px">
    The MCP server screen showing the results of testing an MCP server and discovering its tools
    </span>
</div>
...
<div class="blog-content-block">
    <img src="/img/blog/threadbot-running-started.png" />
    <span style="opacity:0.5;font-size:14px">
    The bot running on the UI, actively responding to a prompt
    </span>
</div>
...
<div class="blog-content-block">
    <img src="/img/blog/threadbot-thinking-block-expanded.png" />
    <span style="opacity:0.5;font-size:14px">
    Expanded view of a thinking chip showing the contents of the LLM's reasoning
    </span>
</div>
...
<div class="blog-content-block">
    <img src="/img/blog/threadbot-tool-call-block-expanded.png" />
    <span style="opacity:0.5;font-size:14px">
    Expanded view of a tool call chip showing the tool input and output
    </span>
</div>
...
<div class="blog-content-block">
    <img src="/img/blog/threadbot-temporal-timeline.png" />
    <span style="opacity:0.5;font-size:14px">
    The workflow timeline in the Temporal UI showing the complete execution history
    </span>
</div>
